  ...
  <div class="w-full h-screen flex flex-col bg-gray-100 overflow-hidden" id="demo_wrap">
    ...
    <div class="flex flex-row justify-center w-full m-auto relative z-10" style="height:90%">
        <div class="flex flex-col w-full md:w-5/12 bg-gray-100 rounded-lg">
            <div class="m-auto w-4/5 mt-4 mb-0">
                ...
                <div class="m-auto relative" style="width:300px;height:300px">
                    <img class="w-full rounded-full block m-auto h-full" src="@/img/mirio.jpg" alt="Album Pic">
                    <div class="cd-center">
      ...
      <div class="w-7/12 hidden md:block">
          ...
          <ul class="w-full overflow-auto m-auto mb-2 bg-gray-100 pt-2" style="max-height:100%" id="journal-scroll">
              <li @click="selectSound(indexo)" :style="indexo == index ? '' : ''" :class="indexo == index ? 'bg-gradient-to-r from-red-500 via-red-600 to-red-700 text-white':''" class="flex py-1 rounded cursor-pointer w-11/12 m-auto" v-for="(audio,indexo) in audios" :key="indexo">
            ...
            <div class="w-4/5 flex md:w-8/12 items-center">
                ...
                <div class="mt-1 relative w-8/12 md:w-10/12">
                    ...
                    <div class="flex w-full justify-end h-1 rounded-full relative" :style="{'width' : step + '%'}">
                        <span id="progressButtonTimer" class="w-3 h-3 md:w-4 md:h-4 bg-gradient-to-r from-red-500 to-red-700 absolute pin-r pin-b -mb-1 rounded-full shadow"></span>
                    </div>
